...
for i in range(num_of_enemies):
    ...
    enemyX.append(random.randint(1450,1550))
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.x >= screen_width/1.5+300:
            self.rect.x = screen_width/1.5+300
...
while running :
    ...
    for i in range(num_of_enemies):
        ...
        gameover_2 = game_over_2(enemyX[i])
        if gameover or gameover_2:
            running = False
